  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        premium: "0 0 0 1px rgba(255, 102, 0, 0.1), 0 4px 8px rgba(0, 0, 0, 0.1), 0 16px 32px rgba(0, 0, 0, 0.05)",
        "card-hover": "0 25px 50px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(255, 102, 0, 0.1)",
        "button-hover": "0 15px 30px rgba(255, 102, 0, 0.4)",
        "neural-glow": "0 0 40px rgba(255, 102, 0, 0.3), inset 0 0 20px rgba(255, 102, 0, 0.1)",
      },
      fontSize: {
        "2xs": "0.625rem",
        "3xl": "2rem",
