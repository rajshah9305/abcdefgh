...
import { Play, ArrowRight, Zap, TrendingUp, Activity, Brain, Network } from "lucide-react"
    ...
    >
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-12">
          <motion.div
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-orange-500/20 to-pink-500/20 backdrop-blur-xl border border-orange-500/30 rounded-full px-6 py-3 mb-8"
            whileHover={{ scale: 1.05 }}
          >
            <Brain size={20} className="text-orange-500" />
            <span className="text-orange-500 font-medium">Next-Generation AI Orchestration</span>
          </motion.div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
          <motion.button
            ...
            className="group relative px-10 py-5 bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl font-bold text-xl overflow-hidden"
            whileHover={{
              scale: 1.05,
              boxShadow: "0 20px 40px rgba(255, 108, 0, 0.4)",
            }}
            whileTap={{ scale: 0.95 }}
          >
            <motion.div
          ...
          <motion.button
            ...
            className="group px-10 py-5 border-2 border-orange-500 rounded-2xl font-bold text-xl hover:bg-orange-500/10 transition-all backdrop-blur-xl"
            whileHover={{
              scale: 1.05,
              borderColor: "#FF00FF",
        ...
        <motion.div variants={itemVariants} className="mt-16 flex justify-center space-x-8 text-sm text-white/60">
